...
function loadDate() {
  var endDate = countdown(new Date(2018, 1, 4, 9, 0, 0));
...
>>>>>>> ba28e58655efd16114a463efc0636051382a9c86
}
    ...
    return (
      <div>
        ...
        <div className="topmenu">
          <div>
            <h2>MangoHacks <span style={{ background: '#FF0000', padding: '3px', fontSize: '0.8em', borderRadius: '5px', fontFamily: 'FuturaLT' }}>Live</span></h2>
          </div>
          <div>
        ...
        <br />
        <div>
          <h1 align="center" className="time" style={{ fontSize: '5em' }}><span id='todaysDate' style={{ fontFamily: 'FuturaLT' }}></span><br /><span style={{ fontSize: '0.5em', fontFamily: 'FuturaLT' }}>Hacking Ends!</span>
          </h1>
        </div>
        <br />
                  ...
                  return (
                    <div className="container right" key={index}>
                      <div className="content">
                        <h2>{i.title}<span className="tags">{i.tags}</span><br /></h2>
                        <p>Starts:<span style={{ fontFamily: 'FuturaLT', color: '#FF4E50' }}>{" " + i.startTime }</span><br />
                          Ends:<span style={{ fontFamily: 'FuturaLT', color: '#FF4E50'}}>{" " + i.endTime}</span>
                          <br />
        ...
        <div className="topmenu">
          <div className="footer" align="center" >Made With <span style={{ color: 'red' }}>&#9829;</span> By MangoHacks</div>
        </div>
